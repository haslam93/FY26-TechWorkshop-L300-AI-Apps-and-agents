...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            ## commented this out await websocket.send_text(fast_json_dumps({"answer": "This application is not yet ready to serve results. Please check back later.", "agent": None, "cart": persistent_cart}))
